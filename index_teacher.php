...
if (isset($_COOKIE['signed']))
 ...
 mysql_query("UPDATE Progress SET $rubric_item = 3 WHERE student_number = $student5") or die(mysql_error());
...
<body>
	...
	<table id="rubric">
		...
		<?php
		$student_list   = mysql_query("SELECT * FROM Users") or die(mysql_error());
		while ($row3 = mysql_fetch_array($student_list))
		{
