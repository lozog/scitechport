...
<body>
<h2>Now editing: Chem13  News Chemistry Contest - evidence</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/12/12b1.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 12b1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 12b1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 12b1 = 2 WHERE student_number = '$student_number'");
