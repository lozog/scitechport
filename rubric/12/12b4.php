...
<h2>Now editing: Evidence of at least two completed technology projects including reflections</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 12b4 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 12b4 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 12b4 = 2 WHERE student_number = '$student_number'");
