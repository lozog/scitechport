...
<body>
<h2>Now editing: Evidence of at least two completed technology projects including reflections</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/12/12b4.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 12b4 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 12b4 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 12b4 = 2 WHERE student_number = '$student_number'");
