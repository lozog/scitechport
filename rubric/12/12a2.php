...
<body>
<h2>Now editing: Semester 1 and 2 report cards</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/12/12a2.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 12a2 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 12a2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 12a2 = 2 WHERE student_number = '$student_number'");
