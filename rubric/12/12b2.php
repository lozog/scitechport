...
<h2>Now editing: Science Lab Notebook</h2>
...

    {
        ...
        $myFile = "users/" . $student_number . "/12/12b2.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 12b2 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 12b2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 12b2 = 2 WHERE student_number = '$student_number'");
