...
<body>
<h2>Now editing: Updated  Resume &amp; Cover Letter showcasing Employability/Learning Skills</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/12/12a1.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 12a1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 12a1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 12a1 = 2 WHERE student_number = '$student_number'");
