...
<h2>Now editing: Updated  Resume &amp; Cover Letter showcasing Employability/Learning Skills</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 12a1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 12a1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 12a1 = 2 WHERE student_number = '$student_number'");
