...
<h2>Now editing: Passport to Safety certificate</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 12b3 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 12b3 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 12b3 = 2 WHERE student_number = '$student_number'");
