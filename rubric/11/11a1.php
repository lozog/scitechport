...
<body>
<h2>Now editing: Post secondary career plan</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/11/11a1.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 11a1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 11a1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 11a1 = 2 WHERE student_number = '$student_number'");
