...
<h2>Now editing: Passport to Safety certificate</h2>
...

    {
        ...
        $myFile = "users/" . $student_number . "/11/11b3.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 11b3 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 11b3 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 11b3 = 2 WHERE student_number = '$student_number'");
