...
<body>
<h2>Now editing: Avogadro Chemistry Contest - evidence</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/11/11b1.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 11b1 = 0 WHERE student_number = '$student_number'");
