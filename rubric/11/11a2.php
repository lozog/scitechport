...
<h2>Now editing: Semester 1 and 2 report cards</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 11a2 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 11a2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 11a2 = 2 WHERE student_number = '$student_number'");
