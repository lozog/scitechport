...
<h2>Now editing: Career investigation summary (e.g. Career Cruising, Ontario Skills Passport, MyBlueprint.ca, Making My Way)</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 10a3 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 10a3 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 10a3 = 2 WHERE student_number = '$student_number'");
