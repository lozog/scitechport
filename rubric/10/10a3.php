...
<body>
<h2>Now editing: Career investigation summary (e.g. Career Cruising, Ontario Skills Passport, MyBlueprint.ca, Making My Way)</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/10/10a3.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10a3 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10a3 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10a3 = 2 WHERE student_number = '$student_number'");
