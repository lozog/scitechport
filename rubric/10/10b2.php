...
<h2>Now editing: Evidence of at least two completed technology projects (VEX Robotics, Lathe work, Milling work, Welding work, etc.) including reflections</h2>
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10b2 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10b2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10b2 = 2 WHERE student_number = '$student_number'");
