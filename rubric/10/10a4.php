...
<body>
<h2>Now editing: Young Worker Awareness Program Certificate</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/10/10a4.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10a4 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10a4 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10a4 = 2 WHERE student_number = '$student_number'");
