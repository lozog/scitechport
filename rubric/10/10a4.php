...
<h2>Now editing: Young Worker Awareness Program Certificate</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 10a4 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 10a4 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 10a4 = 2 WHERE student_number = '$student_number'");
