...
<body>
<h2>Now editing: Science Lab Notebook</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/10/10b1.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10b1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10b1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10b1 = 2 WHERE student_number = '$student_number'");
