...
<h2>Now editing: Science Lab Notebook</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 10b1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 10b1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 10b1 = 2 WHERE student_number = '$student_number'");
