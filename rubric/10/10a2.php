...
<body>
<h2>Now editing: Employability learning skills "Who am I?"</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/10/10a2.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10a2 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10a2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10a2 = 2 WHERE student_number = '$student_number'");
