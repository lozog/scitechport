...
<h2>Now editing: Employability learning skills "Who am I?"</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 10a2 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 10a2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 10a2 = 2 WHERE student_number = '$student_number'");
