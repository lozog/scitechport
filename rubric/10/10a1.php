...
<h2>Now editing: Semester 1 and 2 report cards</h2>
...

    {
        ...
        $myFile = "users/" . $student_number . "/10/10a1.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10a1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10a1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10a1 = 2 WHERE student_number = '$student_number'");
