...
<h2>Now editing: Updated Resume and Cover Letter</h2>
...

    {
		...
		mysql_query("UPDATE Progress SET 10a5 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysql_query("UPDATE Progress SET 10a5 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 10a5 = 2 WHERE student_number = '$student_number'");
