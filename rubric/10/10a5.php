...
<body>
<h2>Now editing: Updated Resume and Cover Letter</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/10/10a5.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 10a5 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 10a5 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 10a5 = 2 WHERE student_number = '$student_number'");
