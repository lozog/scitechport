...
<h2>Now editing: My Future Goals (post secondary/career)</h2>
    ...
    if ($fs == 0)
    {
		...
		mysql_query("UPDATE Progress SET 9a2 = 0 WHERE student_number = '$student_number'");
    }
    else
    {
		$data = fread($fh, filesize($myFile));
		mysql_query("UPDATE Progress SET 9a2 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 9a2 = 2 WHERE student_number = '$student_number'");
