...
<h2>Now editing: Semester 1 and 2 Report Cards</h2>
    ...
    if ($fs == 0)
    {
		...
		mysql_query("UPDATE Progress SET 9a3 = 0 WHERE student_number = '$student_number'");
    }
    else
    {
		$data = fread($fh, filesize($myFile));
		mysql_query("UPDATE Progress SET 9a3 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 9a3 = 2 WHERE student_number = '$student_number'");
