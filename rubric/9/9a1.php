...
<h2>Now editing: Why I took Sci-Tech</h2>
    ...
    if ($fs == 0)
    {
		...
		mysql_query("UPDATE Progress SET 9a1 = 0 WHERE student_number = '$student_number'");
    }
    else
    {
		$data = fread($fh, filesize($myFile));
		mysql_query("UPDATE Progress SET 9a1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysql_query("UPDATE Progress SET 9a1 = 2 WHERE student_number = '$student_number'");
