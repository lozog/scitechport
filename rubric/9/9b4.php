...
<h2>Now editing: Passport to Safety certificate</h2>
...

    {
        ...
        $myFile = "users/" . $student_number . "/9/9b4.html";
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 9b4 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 9b4 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 9b4 = 2 WHERE student_number = '$student_number'");
