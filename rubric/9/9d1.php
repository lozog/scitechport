...
<body>
<h2>Now editing: At least one unique item about your SciTech experiences (i.e. SciTech Council, Regional Science Fair, contests &#38; competitions, Skills Canada, Rocketry, Robotics, Junior Solar Car) with a completed reflection(s).</h2>
	<form method="post">
...

    {
        ...
        $myFile = "users/" . $student_number . "/9/9d1.html";
...

    {
		...
		//mysqli_query($connection, "UPDATE Progress SET 9d1 = 0 WHERE student_number = '$student_number'");
...

    {
		...
		mysqli_query($connection, "UPDATE Progress SET 9d1 = 1 WHERE student_number = '$student_number'");
...
?></textarea>
		...
		if (isset($_POST['isDone'])){
			mysqli_query($connection, "UPDATE Progress SET 9d1 = 2 WHERE student_number = '$student_number'");
