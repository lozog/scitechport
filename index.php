...
<body>
    ...
    if (isset($_COOKIE['ID_my_site']))
    {
		...
		$result4 = mysql_query("SELECT * FROM Users WHERE student_number='$student_number'");
        ...
        $table = mysql_query("SELECT * FROM Users WHERE student_number = '$student_number'") or die(mysql_error());
        while ($row2 = mysql_fetch_array($table))
        {
